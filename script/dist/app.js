...
workExperienceBtn?.addEventListener("click", (e) =>
  addMore(e, "work-experience")
);
academicBtn?.addEventListener("click", (e) =>
  addMore(e, "academic-qualificationField")
);
...
generateResumeButton?.addEventListener("click", (e) => {
  e.preventDefault();
  document.querySelector("#nameT1").textContent =
    document.querySelector("#nameField")?.value || "";
  document.querySelector("#emailT").textContent =
    document.querySelector("#emailField")?.value || "";
  document.querySelector("#emailT").href = `mailto:${
    document.querySelector("#emailField")?.value || ""
  }`;
  document.querySelector(".phone").innerHTML =
    document.querySelector("#contactField")?.value || "";
  document.querySelector(".phone").href = `tel:${
    document.querySelector("#contactField")?.value || ""
  }`;
  document.querySelector(".professionT").innerHTML =
    document.querySelector("#professionField")?.value || "";
  document.querySelector("#addressT").textContent =
    document.querySelector("#addressField")?.value || "";
  document.querySelector("#facebookT").href =
    document.querySelector("#facebookLink")?.value || "";
  document.querySelector("#instagramT").href =
    document.querySelector("#InstagramField")?.value || "";
  document.querySelector("#linkedinT").href =
    document.querySelector("#linkedinField")?.value || "";
  // Profile Pic
  ...
  // Objective
  document.querySelector("#objectiveT").innerHTML =
    document.querySelector("#objectiveField")?.value || "";
  // Work Experience :
  let workExperienceText = document.getElementsByClassName(
