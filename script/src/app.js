...
generateResumeButton?.addEventListener("click", (e) => {
    ...
    document.querySelector("#facebookT").href = document.querySelector("#facebookField")?.value || '';
    document.querySelector("#instagramT").href = document.querySelector("#InstagramField")?.href || '';
